export default function Benefits(){
    return(
        ...
        <div>
            <img src="https://sandbox.elemisthemes.com/assets/img/photos/about18@2x.jpg"
      ...
      >
        ...
        />
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="text-gray-800 text-md font-bold">Career Growth</h1>
                    <p className="text-gray-500 text-base">Duis mollis gravida commodo id luctus erat porttitor ligula, eget lacinia odio sem aget elit nullam quis risus eget.</p>
                </div>
            </div>
            <div className="flex  gap-5">
                <div>
      ...
      >
        <g>
          ...
          />
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="text-gray-800 text-md font-bold">Work From Anywhere</h1>
                    <p className="text-gray-500 text-base">Duis mollis gravida commodo id luctus erat porttitor ligula, eget lacinia odio sem aget elit nullam quis risus eget.</p>
                </div>
            </div>
            <div className="flex  gap-5">
      ...
      >
        ...
        />
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="text-gray-800 text-md font-bold">Smart Salary</h1>
                    <p className="text-gray-500 text-base">Duis mollis gravida commodo id luctus erat porttitor ligula, eget lacinia odio sem aget elit nullam quis risus eget.</p>
                </div>
            </div>
            <div className="flex  gap-5">
      ...
      >
        <g>
          ...
          />
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="text-gray-800 text-md font-bold">Medical Insurance</h1>
                    <p className="text-gray-500 text-base">Duis mollis gravida commodo id luctus erat porttitor ligula, eget lacinia odio sem aget elit nullam quis risus eget.</p>
                </div>
            </div>
            <div className="flex  gap-5">
      ...
      >
        ...
        />
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="text-gray-800 text-lg font-bold">Flexible Hours</h1>
                    <p className="text-gray-500 text-base">Duis mollis gravida commodo id luctus erat porttitor ligula, eget lacinia odio sem aget elit nullam quis risus eget.</p>
                </div>
            </div>
            <div className="flex  gap-5">
      ...
      >
        ...
        />
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="text-gray-800 text-md font-bold">Amazing Work Culture</h1>
                    <p className="text-gray-500 text-base">Duis mollis gravida commodo id luctus erat porttitor ligula, eget lacinia odio sem aget elit nullam quis risus eget.</p>
                </div>
            </div>
        ...
        <div><button className="px-4 py-3 bg-blue-700 text-white rounded-full"
        >Join Our Team</button></div>
        </div>
    )
}