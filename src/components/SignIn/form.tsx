...
export default function Form(){
    ...
    return(
        <div className=" flex flex-col justify-center items-center ">
            ...
            <h1 className="text-grey-900 text-2xl font-bold">Welcome Back</h1>
            <p className="text-xl text-gray-500 text-start ">Fill your email and password to sign in.</p>
            </div>
            <form className="flex flex-col justify-center items-center gap-4 pt-3">
                ...
                <p className="text-md">Don't have an account? <span className="text-blue-500">Sign up</span></p>
