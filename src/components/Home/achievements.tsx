...
export default async function Achievements() {
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row gap-30 justify-center items-center md:pb-30">
